...
public class PersonaDAOMS extends ConexionSQL implements PersonaDAO {
    ...
    public int insertar(PersonaVO personaNaturalVO) throws Exception {
        ...
        try {
            ...
            pstm.setLong(2, personaNaturalVO.getTipoDocumentoPersona().getIdTipoDocumento());
            ...
            pstm.setInt(10, personaNaturalVO.getRolPersona().getIdRol());
    ...
    public ArrayList<PersonaVO> listar() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                personaNaturalVO.getTipoDocumentoPersona().setIdTipoDocumento(t++);
                ...
                personaNaturalVO.getRolPersona().setIdRol(t++);
